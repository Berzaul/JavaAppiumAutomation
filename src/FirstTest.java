...
public class FirstTest {
    ...
    public void setUp() throws Exception
    {
        ...
        capabilities.setCapability("app", "/Users/egormuradkhanyan/Desktop/JavaAppiumAutomation/apks/org.wikipedia.apk");
...
//Ex3
    ...
    public void testCountResults()
    {
        ...
        int elements_count = getAmountOfElements(
                By.xpath(search_result_locator)
        );
...
//Ex4
    ...
    public void testAmountOfEmptySearch()
    {
        ...
        String search_line = "fsf3efwffwf";
...
//Ex6
    ...
    protected void swipeUpToFindElement(By by, String error_message, int max_swipes) {
        ...
        while (driver.findElements(by).size() == 0)
        {
            ...
            {
                waitForElementPresent(by, "Cannot fond element by swiping up. \n" + error_message, 0);
                return;
            }
            swipeUpQuick();
            ++already_swiped;
