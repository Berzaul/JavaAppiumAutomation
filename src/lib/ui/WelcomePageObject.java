...
public class WelcomePageObject extends MainPageObject
{
    private static final String
        ...
        STEP_ADD_OR_EDIT_PREFERRER_LANG_LINK = "id:Add or edit preferred languages",
    ...
    public void waitForAddOrEditPrefarredLangText()
    {
        this.waitForElementPresent(STEP_ADD_OR_EDIT_PREFERRER_LANG_LINK, "Cannot find 'Add or edit preferred languages' link", 10);
    }
